...
(NOTE - some of the screenshots are old/obsolete; I'll redo them soon)
...
- [4
           ...
           Code Folding](#Code_Folding)
- [5
          
          
           Background error parsing](#Background_error_parsing)
- [6
          
          
           Semantic syntax highlighting,](#Semantic_syntax_highlighting.2C)
- [7
          
          
           Mark Occurrences](#Mark_Occurrences)
- [8
          
          
           Go To Declaration](#Go_To_Declaration)
- [9
          
          
           Instant Rename](#Instant_Rename)
- [10
...
- [12
           ...
           Parameter Hints](#Parameter_Hints)
- [13
          
          
           Smart Indent](#Smart_Indent)
- [14
          
          
           Smart Selection](#Smart_Selection)
- [15
...
- [17
           ...
           Live Code Templates](#Live_Code_Templates)
- [18
          
          
           RDoc Support and String Support](#RDoc_Support_and_String_Support)
- [19
...
The structure analyzer is aware of Ruby constructs:
...
Charlie's ruby spec (
     [http://www.headius.com/rubyspec/index.php/Ruby_Language](https://web.archive.org/web/20111120002454/http://www.headius.com/rubyspec/index.php/Ruby_Language)
     )
...
[[1]](https://web.archive.org/web/20111120002454/http://blogs.sun.com/tor/resource/improved-rdoc2_RubyEditing.png)
...
Hit Alt-P (or Ctrl-P) to see the parameters for the current method call. The current
...
progressively larger/smaller code blocks around the caret. For example, if you're within
a
     
      for
     
     block, it will first select the for block, then the surrounding
     
      if
     
     block, then the
method definition, then the class, then the module. Within a comment, first the
line is selected, then the whole comment block, then whatever logical code block surrounds
the comment.
...
More details on these are described in the
...
Once enabled, the IDE will try to infer return types for methods and display those types in the navigator and in the code completion dialog. Inferring method types might be slow for some projects and there are certain constructs that the IDE don't know how to infer as of now, so it is not 100% accurate.
     ...
     Retrieved from "
     [http://wiki.netbeans.org/RubyEditing](../RubyEditing/RubyEditing.md)
     "
